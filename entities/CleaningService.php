<?php
// Cleaning Service Entity

// Include dependencies
require_once __DIR__ . '/../ConnectiontoDB.php';

/**
 * Entity class representing a cleaning service.
 * Handles all data access and business logic for cleaning services.
 */
class CleaningService
{
    ...
    // Save a new cleaning service to the database
    ...
    // Update this cleaning service in the database
    ...
    // Get cleaner (user) by service ID
    ...
    // Get all services by a specific cleaner
