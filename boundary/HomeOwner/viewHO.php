<?php
// View HO services offered by Cleaning Services
...
<head>
    ...
    <style>
        ...
        .container { background: white; padding: 20px; max-width: 100vw; margin: 0 auto; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); box-sizing: border-box; overflow-x: hidden; }
        ...
        table { width: 100%; border-collapse: collapse; table-layout: auto; min-width: 0 !important; }
        th, td { border: 1px solid #ddd; padding: 10px; text-align:left; white-space: normal; word-break: break-word; }
        .desc-cell { white-space: normal; word-break: break-word; max-width: none; }
        .action-links { display: flex; flex-wrap: wrap; gap: 8px; justify-content: center; }
        .action-links a { flex: 1 1 auto; min-width: 80px; padding: 8px 10px; text-align: center; white-space: normal; word-break: break-word; border-radius: 4px; color: white !important; font-weight: bold; font-size: 1rem; background-color: #007bff; text-decoration: none; box-sizing: border-box; transition: background 0.2s; }
        ...
        .shortlist-button, .remove-button, .back-button { padding: 10px 20px; border: none; border-radius: 4px; color: white; text-decoration: none; margin-right: 10px; cursor: pointer; }
        ...
        @media (max-width: 900px) {
            ...
            .action-links a { min-width: 70px; font-size: 0.9rem; }
        }
    </style>
</head>
<body>
